...
namespace backend.Migrations
{
    ...
    [Migration("20241021202011_session")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Auth.Model.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("backend.Entities.Hotel", b =>
                {
                    ...
                    b.Property<string>("HotelAdminId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("backend.Entities.Session", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("backend.Auth.Model.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("backend.Auth.Model.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("backend.Entities.Hotel", b =>
                {
                    b.HasOne("backend.Auth.Model.User", "HotelAdmin")
                        .WithMany()
